...
## **Creator:**
A contract to eat the bytecode load of new ZcToken and VaultTracker market deployment. Has one method for the creation of new markets, which can only be called by `Marketplace.sol`.
